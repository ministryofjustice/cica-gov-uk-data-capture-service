                ...
                schema: {
                    ...
                    properties: {
                        'q--when-was-the-crime-reported-to-police': {
                            ...
                            format: 'date-time',
                            description:
                                'For example, 28 2 2020. You can enter an approximate date.',
                            errorMessage: {
                                format:
            ...
            'p--whats-the-crime-reference-number': {
                schema: {
                    ...
                    errorMessage: {
                        required: {
                            'q--whats-the-crime-reference-number':
                                'Enter the crime reference number'
                        }
                    },
                    examples: [
                        {
            ...
            'p-applicant-select-reasons-for-the-delay-in-reporting-the-crime-to-police': {
                schema: {
                    ...
                    properties: {
                        'q-applicant-select-reasons-for-the-delay-in-reporting-the-crime-to-police': {
                            title:
                                'Select reasons for the delay in reporting the crime to the police',
                            type: 'array',
                            maxItems: 3,
                            uniqueItems: true,
                            description: 'Select all options that apply to you.',
